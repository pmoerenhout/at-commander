...
import org.atcommander.module.telit.types.ActiveSet;
...
// #RFSTS: ,32767,-47,,,19,27,,,"204230090288415","",0,2
  ...
  public void testReadNetworkStatusResponse() {
    ...
    assertEquals(new Integer(1001), readNetworkStatusResponse.getArfcn());
    assertEquals(new Integer(-80), readNetworkStatusResponse.getRssi());
    ...
    assertEquals(new Integer(5), readNetworkStatusResponse.getTxPower());
    assertEquals(new Integer(19), readNetworkStatusResponse.getMobilityManagementState());
    assertEquals(new Integer(10), readNetworkStatusResponse.getRadioResourceState());
    assertEquals(new Integer(2), readNetworkStatusResponse.getNetworkOperatorMode());
    ...
    assertEquals(new Integer(1), readNetworkStatusResponse.getServiceDomain());
    assertEquals(new Integer(2), readNetworkStatusResponse.getActiveBand());
  ...
  public void testReadNetworkStatusResponseWithNoNetwork() {
    ...
    assertEquals(new Integer(1331), readNetworkStatusResponse.getArfcn());
    assertEquals(new Integer(-77), readNetworkStatusResponse.getRssi());
    assertEquals("0FDE", readNetworkStatusResponse.getLocationAreaCode());
    assertEquals("01", readNetworkStatusResponse.getRoutingAreaCode());
    assertEquals(new Integer(6), readNetworkStatusResponse.getTxPower());
    assertEquals(new Integer(18), readNetworkStatusResponse.getMobilityManagementState());
    assertEquals(new Integer(10), readNetworkStatusResponse.getRadioResourceState());
    assertEquals(new Integer(2), readNetworkStatusResponse.getNetworkOperatorMode());
    assertEquals("9877", readNetworkStatusResponse.getCellId());
    assertEquals("204047930002270", readNetworkStatusResponse.getImsi());
    assertNull(readNetworkStatusResponse.getOperatorName());
    assertEquals(new Integer(0), readNetworkStatusResponse.getServiceDomain());
    assertEquals(new Integer(2), readNetworkStatusResponse.getActiveBand());
  ...
  public void testReadNetworkStatusResponseTMobile() {
    ...
    assertEquals(new Integer(848), readNetworkStatusResponse.getArfcn());
    assertEquals(new Integer(-89), readNetworkStatusResponse.getRssi());
    assertEquals("03F8", readNetworkStatusResponse.getLocationAreaCode());
    assertNull(readNetworkStatusResponse.getRoutingAreaCode());
    assertEquals(new Integer(0), readNetworkStatusResponse.getTxPower());
    assertEquals(new Integer(19), readNetworkStatusResponse.getMobilityManagementState());
    assertEquals(new Integer(29), readNetworkStatusResponse.getRadioResourceState());
    ...
    assertEquals(new Integer(0), readNetworkStatusResponse.getServiceDomain());
    assertEquals(new Integer(3), readNetworkStatusResponse.getActiveBand());
  ...
  public void testReadNetworkStatusResponseKPN() {
    ...
    assertEquals(new Integer(14), readNetworkStatusResponse.getArfcn());
    assertEquals(new Integer(-80), readNetworkStatusResponse.getRssi());
    ...
    assertEquals(new Integer(5), readNetworkStatusResponse.getTxPower());
    assertEquals(new Integer(19), readNetworkStatusResponse.getMobilityManagementState());
    assertEquals(new Integer(11), readNetworkStatusResponse.getRadioResourceState());
    assertNull(readNetworkStatusResponse.getNetworkOperatorMode());
  ...
  public void testReadNetworkStatusResponseVodafone() {
    ...
    assertEquals("204 04", readNetworkStatusResponse.getPlmn());
    assertEquals(new Integer(1020), readNetworkStatusResponse.getArfcn());
    assertEquals(new Integer(-63), readNetworkStatusResponse.getRssi());
    assertEquals("00DE", readNetworkStatusResponse.getLocationAreaCode());
  ...
  public void testReadNetworkStatusResponseVodafone2() {
    ...
    assertEquals(new Integer(-1), readNetworkStatusResponse.getArfcn());
    assertEquals(new Integer(-47), readNetworkStatusResponse.getRssi());
    assertEquals("FFFF", readNetworkStatusResponse.getLocationAreaCode());
    assertEquals("FF", readNetworkStatusResponse.getRoutingAreaCode());
    assertEquals(new Integer(255), readNetworkStatusResponse.getTxPower());
    assertEquals(new Integer(19), readNetworkStatusResponse.getMobilityManagementState());
    assertEquals(new Integer(27), readNetworkStatusResponse.getRadioResourceState());
    assertNull(readNetworkStatusResponse.getNetworkOperatorMode());
  ...
  public void testReadNetworkStatusResponseKpn() {
    ...
    assertEquals("204 08", readNetworkStatusResponse.getPlmn());
    assertEquals(new Integer(7), readNetworkStatusResponse.getArfcn());
    assertEquals(new Integer(-92), readNetworkStatusResponse.getRssi());
    assertEquals("0CBC", readNetworkStatusResponse.getLocationAreaCode());
    assertEquals("FF", readNetworkStatusResponse.getRoutingAreaCode());
    assertEquals(new Integer(5), readNetworkStatusResponse.getTxPower());
    assertEquals(new Integer(19), readNetworkStatusResponse.getMobilityManagementState());
...
//  }
  ...
  public void test_read_network_status_response_vodafone_incorrect_13_tokens() {
    ...
    assertNull(readNetworkStatusResponse.getPlmn());
    assertEquals(new Integer(32767), readNetworkStatusResponse.getArfcn());
    assertEquals(new Integer(-47), readNetworkStatusResponse.getRssi());
    assertEquals(null, readNetworkStatusResponse.getLocationAreaCode());
    assertEquals(null, readNetworkStatusResponse.getRoutingAreaCode());
  ...
  public void test_read_network_status_response_vodafone_incorrect_13_tokens_2() {
    ...
    assertNull(readNetworkStatusResponse.getTxPower());
    assertEquals(new Integer(18), readNetworkStatusResponse.getMobilityManagementState());
    assertEquals(new Integer(5), readNetworkStatusResponse.getRadioResourceState());
    assertNull(readNetworkStatusResponse.getNetworkOperatorMode());
    assertNull(readNetworkStatusResponse.getCellId());
    assertEquals("204230090288415", readNetworkStatusResponse.getImsi());
    assertEquals("vodafone NL", readNetworkStatusResponse.getOperatorName());
    assertEquals(new Integer(1), readNetworkStatusResponse.getServiceDomain());
    assertEquals(new Integer(0), readNetworkStatusResponse.getActiveBand());
  ...
  public void test_read_network_status_response_vodafone_3() {
    ...
    assertEquals("204 04", readNetworkStatusResponse.getPlmn());
    assertEquals(new Integer(998), readNetworkStatusResponse.getArfcn());
    assertEquals(new Integer(-73), readNetworkStatusResponse.getRssi());
    assertEquals("00DE", readNetworkStatusResponse.getLocationAreaCode());
    assertEquals("00", readNetworkStatusResponse.getRoutingAreaCode());
    assertEquals(new Integer(5), readNetworkStatusResponse.getTxPower());
    assertEquals(new Integer(19), readNetworkStatusResponse.getMobilityManagementState());
...
//    assertEquals("00", readNetworkStatusResponse.getRoutingAreaCode());
    assertEquals(new Integer(0), readNetworkStatusResponse.getTxPower());
    assertEquals(new Integer(64), readNetworkStatusResponse.getDrx());
    assertEquals(new Integer(0), readNetworkStatusResponse.getMobilityManagementState());
    assertEquals(new Integer(4), readNetworkStatusResponse.getRadioResourceState());
    assertEquals(new Integer(2), readNetworkStatusResponse.getNetworkOperatorMode());
    assertEquals("2DDC1C3", readNetworkStatusResponse.getCellId());
    assertEquals("204047930002270", readNetworkStatusResponse.getImsi());
    assertEquals("vodafone NL", readNetworkStatusResponse.getOperatorName());
    assertEquals(new Integer(1), readNetworkStatusResponse.getServiceDomain());
    assertEquals(new Integer(0), readNetworkStatusResponse.getNumberOfActiveSet());
...
//    assertEquals("00DE", readNetworkStatusResponse.getLocationAreaCode());
//    assertEquals("00", readNetworkStatusResponse.getRoutingAreaCode());
    assertEquals(new Integer(24), readNetworkStatusResponse.getTxPower());
    assertEquals(new Integer(64), readNetworkStatusResponse.getDrx());
    assertEquals(new Integer(19), readNetworkStatusResponse.getMobilityManagementState());
    assertEquals(new Integer(4), readNetworkStatusResponse.getRadioResourceState());
    assertEquals(new Integer(2), readNetworkStatusResponse.getNetworkOperatorMode());
    ...
    assertEquals("vodafone NL", readNetworkStatusResponse.getOperatorName());
    assertEquals(new Integer(1), readNetworkStatusResponse.getServiceDomain());
    assertEquals(new Integer(1), readNetworkStatusResponse.getNumberOfActiveSet());
