...
public class NetworkRegistrationResponseTest extends BaseCommandTest {
  ...
  public void test_creg_unsolicited_1() throws Exception {
    ...
    final NetworkRegistrationResponse networkRegistrationResponse = new NetworkRegistrationResponse();
  ...
  public void test_creg_unsolicited_creg_1_with_lac_and_with_cellid() throws Exception {
    ...
    assertEquals(new Integer(0x2e2ee99), networkRegistrationResponse.getCellId());
  ...
  public void test_unsolicited_creg_2_with_lac_and_with_cellid_and_with_act() throws Exception {
    final String line = "+CREG: 2,\"00DE\",\"2D33F2C\",2";
    ...
    assertEquals(RegistrationState.SEARCHING, networkRegistrationResponse.getRegistrationState());
    assertEquals(new Integer(0x00de), networkRegistrationResponse.getLac());
    assertEquals(new Integer(0x2d33f2c), networkRegistrationResponse.getCellId());
    assertEquals(AccessTechnology.UTRAN, networkRegistrationResponse.getAccessTechnology());
  }
